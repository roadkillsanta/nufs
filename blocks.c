...
void *get_inode_table() {
  ...
  // The inode table is stored immediately after the inode bitmap and the block bitmap
  return block + BLOCK_BITMAP_SIZE + INODE_BITMAP_SIZE;
}
